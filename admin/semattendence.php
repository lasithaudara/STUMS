...
<html lang="en">
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>STUMS</b></a>
            <!--logo end-->
				  ...
				  <div class="row">						
						<! -- THEME BUTTONS -->
							<div class="showback">
								...
								<!-- Standard button -->
								<button type="button" class="btn btn-theme" >Month wise Attendence</button>
								<button type="button" class="btn btn-theme02"><a class="active" href="index.html">Semester wise Attendence</button>
								  ...
								  <!--CUSTOM CHART START -->
									<div class="col-md-12 mt">
										<div>
																	<!-- DROPDOWN BUTTONS -->
											<div class="showback">
												<h4><i class="fa fa-angle-right"></i>Semester wise Attendence</h4>
												<!-- Single button -->
												<div class="btn-group">
										  ...
										  <div class="custom-bar-chart">
											  ...
											  <?php $name = "10";?>
												  ...
												  <div class="value tooltips" data-original-title="8.500" data-toggle="tooltip" data-placement="top"><?php echo $name; ?>%</div>
											  </div>
											  <div class="bar ">
